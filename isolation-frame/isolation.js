// Isolation hook — ADR-0013 active.
//
...
(function () {
    ...
    // Prototype-free allowlist (prevents pollution of `ALLOWED["constructor"]`
    ...
    // Onboarding commands — no frontend payload for any of these.
    ...
    // Restart the sidecar after the onboarding wizard has persisted
    ...
    function validateSidecarUrl(url) {
        ...
        // Userinfo rejected — B2 bypass vector found during adversarial security review (4 PoC vectors).
