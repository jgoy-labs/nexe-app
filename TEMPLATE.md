...
Baseline tests (pre-`v0.1.1-fase0`):
...
- **Vitest:** 55 (2 test files: isolation.test.js + main.test.js, at v0.1.1-fase0).
- **Clippy:** clean on lib+bins.

Exact numbers verified at `v0.1.1-fase0` tag. See CHANGELOG.
