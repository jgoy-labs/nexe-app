...
**Data:** 2026-04-18
**Estat:** Accepted — **Empirically verified 2026-04-18**
**Decidit per:** Jordi Goy
**Entorn de validació:** VM Linux (Ubuntu 24.04 ARM64 + WebKitGTK 2.50.4 sota virtualització ARM)
...
**Entorn de test:**
- Entorn: VM Linux dedicada sota virtualització ARM (Apple Silicon).
...
- ✅ La revisió adversarial assistida per IA (2026-04-17) l'identificava com a "risc P1 probabilitat mitjana" — **risc descartat**
...
La validació s'ha fet en una VM Linux (Ubuntu 24.04 ARM64) sota virtualització ARM, reutilitzable per a futurs tests cross-platform de nexe-app, server-nexe i altres projectes Tauri/Rust/Node.

## Referències

- [ADR-0009 Protocol plugin://](ADR-0009-plugin-uri-scheme.md)
- [Tauri v2 custom protocols docs](https://tauri.app/develop/protocols/)
- Revisió adversarial assistida per IA 2026-04-17 (risc identificat com a P1 probabilitat mitjana — **resolt**)
