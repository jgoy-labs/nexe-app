...
| [0012](ADR-0012-plugin-scheme-linux.md) | `plugin://` Linux WebKitGTK | Accepted — Verified | 2026-04-18 |
| [0013](ADR-0013-isolation-pattern.md) | Isolation Pattern | Accepted — Active | 2026-04-18 |
| [0014](ADR-0014-plugin-integrity.md) | Plugin integrity SHA-256 | Accepted — Active (atomic snapshot) | 2026-04-21 |
...
- original plan
- AI-assisted adversarial review inputs
