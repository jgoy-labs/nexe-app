...
@app.get("/api/v1/system/health", response_model=dict, operation_id="system_health")
...
@app.get("/health/ready", response_model=dict, operation_id="health_ready")
...
@app.post("/api/v1/system/shutdown", response_model=dict, operation_id="system_shutdown", status_code=200)
...
@app.get("/", response_model=dict, operation_id="root")
